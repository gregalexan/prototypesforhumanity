...
URL = "https://ihl-databases.icrc.org/en/ihl-treaties/treaties-and-states-parties"
OUTPUT_FILE = "treaties_2.txt"

options = Options()
# options.add_argument('--headless')  # για silent λειτουργία
